...
preload() {
        ...
        this.load.image('nubesTop', '../assets/imgs/nubeTop.webp')
...
create() { 
        ...
        /// VARIABLES DE CADA PANTALLA
            ...
            // protagonista
                let heliInicial = [1500,400];

            // elementos del fondo 

            let posCielo    =[0, 0,  ancho_escena,   606];
            let posCampo    =[0, 624,ancho_escena,   700];
            let posMontana  =[0, 570,ancho_escena,   119];
            let posZacate   =[0, 750,ancho_escena,   197];
            let posNubes    =[600,100];
            ...
            let posInicioTuristaPerdido=[4500,270];
            let posInicioMonos=[3300,50,2900,50,2690,50,2660,50];
            let posInicioLapas=[-30,200];
        ...
        // PROTAGONISTA:
            ...
            this.mini_chopper = new Chopper(this,heliInicial[0],heliInicial[1],'animHelicoptero');
        ...
        // EL ESCENARIO
            ...
            this.cielo =    this.add.tileSprite(posCielo[0],posCielo[1],posCielo[2],posCielo[3], 'sky1');               this.cielo.setOrigin(0);
        ...
        this.arbolZero =    new Arbol(this, posArboles[0], posArboles[1], posArboles[2]); // limite izquierda
        this.arbolDiez =    new Arbol(this, posArboles[3], posArboles[4], posArboles[5]); //limite derecha
        ...
        this.rescatePlat = this.physics.add.staticImage(posPlataformas[0], posPlataformas[1], 'plat_grande');
        ...
        this.plat2 = this.physics.add.staticImage(posPlataformas[2], posPlataformas[3], 'plat_grande');
            this.plat2.setImmovable(); this.plat2.setSize(310,5);  this.plat2.setOffset(15,78);

        this.plat3 = this.physics.add.staticImage(posPlataformas[4], posPlataformas[5], 'plat_grande');
        ...
        //  NUBES MALAS
             ...
             this.nubemala1 = new NubesMalas(this, posNubesMalas[0],        posNubesMalas[1],   'nubesmalas');
             this.nubemala2 = new NubesMalas(this, posNubesMalas[0]+1*distancia_entre_nubes,   posNubesMalas[1]-20,'nubesmalas');
             this.nubemala3 = new NubesMalas(this, posNubesMalas[0]+2*distancia_entre_nubes,   posNubesMalas[1],'nubesmalas');
             this.nubemala4 = new NubesMalas(this, posNubesMalas[0]+3*distancia_entre_nubes,   posNubesMalas[1]+20,'nubesmalas');
             this.nubemala5 = new NubesMalas(this, posNubesMalas[0]+4*distancia_entre_nubes,   posNubesMalas[1],'nubesmalas');
             this.nubemala6 = new NubesMalas(this, posNubesMalas[0]+5*distancia_entre_nubes,   posNubesMalas[1]-20,'nubesmalas');

        // NUBES TOP
             this.nubeTop1 = new NubeTop(this, 1600, 50,'nubesTop');
             this.nubeTop2 = new NubeTop(this, 2600, 100,'nubesTop');
             this.nubeTop3 = new NubeTop(this, 3600, 150,'nubesTop');
             this.nubeTop4 = new NubeTop(this, 4600, 200,'nubesTop');
        ...
        //  PERSONAJES MOVILES
            ...
            this.mono1 = new Enemigo(this, posInicioMonos[0],posInicioMonos[1],'mono');
            this.mono2 = new Enemigo(this, posInicioMonos[2],posInicioMonos[3],'mono');
            this.mono3 = new Enemigo(this, posInicioMonos[4],posInicioMonos[5],'mono');
            this.mono4 = new Enemigo(this, posInicioMonos[6],posInicioMonos[7],'mono');
            ...
            this.firework = new Firework(this,heliInicial[0],heliInicial[1]-100,'firework');
...
update() {
        ...
        // MOVIMIENTO DE PERSONAJES SECUNDARIOS
                ...
                this.nubemala1.updateNubesMalas(); this.nubemala2.updateNubesMalas(); 
                ...
                this.mono1.updateEnemigo(); this.mono2.updateEnemigo();
                this.mono3.updateEnemigo(); this.mono4.updateEnemigo();
       ...
       console.log(this.reflejochopper.y);
    ...
    // let velY =  this.mini_chopper.body.velocity.y;
                ...
                if (potenciaX != 0 || potenciaY != 0){ //empezamos a movernos
                    ...
                    if (this.mini_chopper.body.velocity.y > -300){
                        if (potenciaY<0){this.mini_chopper.body.velocity.y -= potenciaY*0.09}}
                    if (this.mini_chopper.body.velocity.y < 300){
                        if (potenciaY>0){this.mini_chopper.body.velocity.y -= potenciaY*0.09}} 
